        ...
        public SelectionPane() {
            ...
            button.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    // Koordinaten müssen gerade sein für Rectangle beim ScreenImage
                    if ((temp1.x % 2) == 1) {
                    	temp1.x = temp1.x+1;
                    }
                    if ((temp1.y % 2) == 1) {
                    ...
                    System.out.println("Point1: " + finalGui.p1.toString() + "Point2: " + finalGui.p2.toString());
            ...
            addComponentListener(new ComponentAdapter() {
                ...
                public void componentResized(ComponentEvent e) {
                    label.setText("Rectangle: " + getX() + " : " + getY() + " | " + getWidth() + " : " + getHeight());
                }
            });
